...
from forms.admin import ArtigoForm, ArtigoEditForm
...
def list_artigos():
    ...
    return render_template(
        'admin/artigos.html', artigos=artigos, title_page='Artigos'
    )
...
def novo_artigo():
    ...
    return render_template(
        'admin/artigo_add.html', form=form
    )
